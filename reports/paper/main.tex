...
\IEEEauthorblockA{Universidad Nacional de Ingenier\'ia, Lima, Peru\\
Computer Vision --- MSc in Artificial Intelligence, 2026-I}}
...
Code, notebooks (ingest to evaluation), audited splits, trained weights and a
sectioned demo video are released; three reproduction routes are documented (demo
