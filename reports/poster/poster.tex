...
\institute{Universidad Nacional de Ingenier\'ia, Lima, Peru \quad---\quad
 Computer Vision, MSc in Artificial Intelligence, 2026-I \quad---\quad
...
($\sim$10 min) \,·\, full pipeline from public data. Code, weights, splits
and video: \textbf{github.com --- released with the course hand-in.}
}
\end{columns}
